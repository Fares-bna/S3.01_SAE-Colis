...
```bash
# Cloner le dépôt
git clone https://github.com/Slaiyyerr/SAE_colis.git
cd SAE_colis
...
| **BOUSLAMA Adel**  | DAO & Base de données  Création et gestion de la BD      | Développement des DAO, logique métier, liaison avec les controllers                |
